...
namespace Utilities.Extensions
{
    public static class Vector3Extensions
    {
        ...
        public static Vector3 NormalizeByMagnitude(this Vector3 v0, float  magnitude){
            return new Vector3( 
                v0.x /  magnitude, 
                v0.y /  magnitude, 
                v0.z /  magnitude);  
        ...
        /// <summary>
        /// Converts a Vector3 to a Vector2 by discarding the y value.
        /// </summary>
        /// <param name="v3">The Vector3 to convert.</param>
        /// <returns>A Vector2 with the x and z values of the Vector3.</returns>
