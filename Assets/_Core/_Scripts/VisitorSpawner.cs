...
namespace _Core._Scripts
{
    public class VisitorSpawner : MonoBehaviour
    {
        ...
        [FoldoutGroup("Settings"),SerializeField]  int numRow;
        [FoldoutGroup("Settings"),SerializeField]  float space;
        [FoldoutGroup("Settings"),SerializeField]  float randomPos;
        [FoldoutGroup("Settings"),SerializeField]  Vector3 rotation;
        [FoldoutGroup("Settings"),SerializeField]  float kidSize;
        [FoldoutGroup("Settings"),SerializeField]  int visitorChanceMin;
        [FoldoutGroup("Settings"),SerializeField]  int visitorChanceMax;
        [FoldoutGroup("Settings"),SerializeField]  float kidOffset;
        
        [FoldoutGroup("Appearance"),SerializeField] Material[] pants;
        [FoldoutGroup("Appearance"),SerializeField] Material[] shirts;
        [FoldoutGroup("Appearance"),SerializeField] Material[] skinTones;
        [FoldoutGroup("Appearance"),SerializeField] Material[] shoes;
        [FoldoutGroup("Appearance"),SerializeField] Material[] hats;
